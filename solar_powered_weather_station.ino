...
//const char *ssid = "xxx"; // Имя вайфай точки доступа
//const char *pass = "xxx"; // Пароль от точки доступа
//const char *mqtt_server = "192.168.1.139"; // Имя сервера MQTT
//const int mqtt_port = 1883; // Порт для подключения к серверу MQTT
//const char *mqtt_user = "xxx"; // Логи от сервер
//const char *mqtt_pass = "xxx"; // Пароль от сервера
